...
const AlabayGuardian = () => {
    ...
    return (
        ...
        className='flex flex-col justify-evenly items-start bg-cover bg-center w-screen h-screen custom-scrollbar heritage p-8'>
            ...
            <div className='flex flex-col justify-center items-start ml-4'>
                ...
                >Alabay Guardian</h1>
                <span
                style={{fontFamily: 'Bebas Neue', color: '#90FFAE'}} className='text-5xl'>SHEPHERD OF THE STEPPES</span>
            </div>
            ...
            <div className='h-full overflow-auto w-full'>
                ...
                <div className='flex flex-col justify-center items-start h-full gap-4'>
                    ...
                    <div className='flex justify-center items-center py-2 pr-10 pl-2 rounded-r-full rounded-l-full ml-4 my-4' style={{backgroundColor: '#90FFAE'}}>
                    ...
                    <h1 className='text-white text-3xl font-bold ml-4' ><span style={{color: '#90FFAE'}}>GAME</span> PREVIEW</h1>
                ...
                <div className='flex flex-col justify-center items-start h-full'>
                    <div className='flex flex-col justify-between items-start mt-[-16px]'>
                        ...
                        >
                            <h1 style={{fontSize: '2rem', color: '#90FFAE', fontWeight: '700'}}>FEATURES</h1>
                            <p className='leading-4'>Explore a variety of landscapes, including <span style={{color: '#90FFAE'}}>mountains</span>, <span style={{color: '#90FFAE'}}>forests</span>, <span style={{color: '#90FFAE'}}>deserts</span>, and <span style={{color: '#90FFAE'}}>ancient ruins</span>.</p>
                            <p className='leading-4'>Use the Alabay's <span style={{color: '#90FFAE'}}>abilities</span> to solve <span style={{color: '#90FFAE'}}>puzzles</span> that involve moving objects, activating mechanisms, or finding hidden clues.</p>
                            ...
                            <div className='flex flex-col justify-center items-start gap-1'>
                                ...
                                <p className='leading-4 ml-2'>- <span style={{color: '#90FFAE'}}>Time Trials</span>: Compete in special timed challenges where the Alabai must navigate through complex mazes or complete puzzles within a time limit.</p> 
                                <p className='leading-4 ml-2'>- <span style={{color: '#90FFAE'}}>Exploration Mastery</span>: A mode that rewards players for fully exploring every nook and cranny of the game's world, uncovering all secrets</p>
                            </div>
                        </div>
